...
<head>
    ...
    <title><?= $title ? $title : 'Bienvenue' ?> | DRHKATImpotLocatif Applicattion !</title>
            ...
            <div class="hpanel">
                <div class="panel-body">
                    <div class="text-center m-b-md custom-login">
                        ...
                        <?php } ?>
                        <hr>
                         <b>Pour acceder a l'application de gestion de paiement de l'impot sur le revenu locatif, veuillez saisir vos identifiants de votre compte.</b>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="float-left text-left">
                            ...
                            | <a href="https://congoagile.com" style="background-color: transparent; color: white; font-weight: bold;">DRHKATImpotRevenuLocatif Application</a>
                        </span>
                    </div>
                </div>
                <div class="col-sm-6" >
                    <div class="float-right text-right" style="margin-right: 10px!important;">
                        ...
                        <span class="small" style="background-color: transparent; color: #ffffff; font-weight: bold;">
                            DRHKATImpotRevenuLocatif et son logo sont des marques déposées de
