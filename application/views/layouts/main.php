...
<html>
    <head>
        ...
        <title>DRHKAT Paiement Impot Revenu Locatif</title>
        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="" class="logo">
                    ...
                    <span class="logo-mini">DRHKAT Impot</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg">DRHKAT Impot</span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
						...
						<li>
                            <a href="#">
                                <i class="fa fa-address-card-o"></i> <span>Declaration Impot</span>
                            </a>
                            <ul class="treeview-menu">
                                ...
                                <li class="active">
                                    <a href="<?php echo site_url('fiche/index');?>"><i class="fa fa-plus"></i> Fiches</a>
                                </li>
							</ul>
                        </li>
						...
						<li>
                            <a href="#">
                                <i class="fa fa-bank"></i> <span>Notes & Paiements</span>
                            </a>
                            <ul class="treeview-menu">
                                ...
                                <li class="active">
                                    <a href="<?php echo site_url('paiement/index');?>"><i class="fa fa-plus"></i> Apurer paiement</a>
                                </li>
							</ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="treeview-menu">
                                <li class="active">
                                    <a href="<?php echo site_url('user/add');?>"><i class="fa fa-plus"></i> creer un nouveau compte</a>
                                </li>
                                <li>
